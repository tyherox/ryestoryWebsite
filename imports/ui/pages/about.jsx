            ...
            <div className="master-contain">
                <div className="contain">
                    ...
                    <div className='section'>
                        <div className="title">
                            <Buffer size="30"/>
                            <h1 className="title-section">OUR STORY</h1></div>
                        <div className="content">
                            <Buffer/>
                            <p>Seemingly small and insignificant, Rye is a hearty, nutritious crop that is an ingredient to many of our foods. We believe there’s a lot of similarities when it comes to how we see our ideas. Although we often dismiss our ideas as insignificant, with the proper nurturing and development, ideas can become powerful influential stories. And aren’t all stories worth telling?
                                <br/><br/>
